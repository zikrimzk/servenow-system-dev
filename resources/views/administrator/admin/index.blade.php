                    ...
                    <div class="card table-card">
                        <div class="card-header">
                            <div class="d-sm-flex align-items-center justify-content-between">
                                <div>
                                    <a href="../admins/course-teacher-add.html" class="btn btn-primary"
                                        data-bs-toggle="modal" data-bs-target="#addAdminModal">Add
                                        Administrator</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <span class="text-muted">[Default: servenow@1234]</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
