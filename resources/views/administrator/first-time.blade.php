...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme_contrast=""
    ...
    <div class="container">
        <form action="{{ route('admin-first-time-update', Crypt::encrypt($admin->id)) }}" method="POST">
            @csrf
            <div class="row justify-content-center align-items-center" style="height: 135vh;">

                <div class="col-md-6 d-sm-block d-none">
                    <h5><span class="text-primary">Hi </span> {{ $admin->admin_firstname }} !</h5>
                    ...
                    <div class="card border border-0 shadow shadow-md">
                        <div class="card-body">
                            ...
                            <div class="d-grid mt-4 mb-3">
                                <button type="submit" class="btn btn-lg btn-primary" id="submit-btn">Change Password</button>
                            </div>
                        </div>
                    </div>
                </div>
